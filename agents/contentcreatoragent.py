...
class ContentCreatorAgent(BaseAgent):
    ...
    def _generate_multiple_choice_questions(self, data_preproc: List[ComponentResultObject]) -> List[ComponentResultObject]:
        ...
        system_prompt = """Du bist ein Experte für Multiple-Choice-Fragen.
        Deine Aufgabe ist es, aus einem Textabschnitt präzise und klare Multiple-Choice-Fragen zu generieren.
        ...
        Antworte NUR mit den Fragen und Antworten zu folgendem Thema: {data_preproc[0]["content"]["original_text"]}
